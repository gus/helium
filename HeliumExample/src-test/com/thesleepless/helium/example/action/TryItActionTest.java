/*
 * Created: Apr 5, 2005
 * File version: "$Id: TryItActionTest.java,v 1.1 2005/04/06 01:01:32 jaknowlden Exp $"
 * 
...
public class TryItActionTest extends TestCase {
  ...
  protected void setUp() throws Exception {
    super.setUp();
    context = HeliumFactory.newHeliumContext(new StringWriter(), new HashMap(1),
        HeliumFactory.newActionRegister(), null);
  ...
  public void testSimpleContent() throws Exception {
    ...
    assertEquals("hello, world", context.getWriter().toString());
  }
  ...
  public void testUsingVar() throws Exception {
    ...
    assertEquals("[temp value]", context.getWriter().toString());
  }

  public void testNoContent() throws Exception {
    context.getDataMap().put("a", "");
    buildArticle("<tryit var=\"a\"/>").parse(context);
    assertTrue(context.getWriter().toString().indexOf("SAXParseException") > -1);
  }
